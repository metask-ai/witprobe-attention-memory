...
\author{%
  ...
  \and Ziyang Wang\\ Metask Lab\\ {\small\texttt{ziyang9986@gmail.com}}
...
deterministic, so sharing does not disturb budget semantics). \input{figs/slotstate}
Four runtime
...
\input{figs/sixpath} The matrix carries the per-dimension verdicts;
...
paper, submitted concurrently; artifact:
\url{https://github.com/metask-ai/witcert-kv-certificates} (arXiv id to appear).
\end{thebibliography}
\endgroup
